        ...
        mouseOnDay: function (e) {
          if (e.events.length > 0) {
            ...
            for (var i in e.events) {
              ...
              var location_html = '<img src="{{site.domain}}/static/img/072-location.svg" className="own-badge"/>&nbsp;' + e.events[i].location;
              var date_html = '<img src="{{site.domain}}/static/img/084-calendar.svg" className="own-badge"/>&nbsp;' + e.events[i].date;
